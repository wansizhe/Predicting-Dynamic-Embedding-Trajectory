...
# LOAD THE NETWORK
def load_network(arg, time_scaling=False):
    """
    ...
    network = 'train'
    datapath = '../../ydzhang/CIKM2019/data/jodie_input_all_6.npy'
...
def test_load_network(time_scaling=True):
    """
    This function loads the input network.
    ...
    network = "test"
    datapath = "../ydzhang/CIKM2019/data/jodie_input_all_5.npy"
