...
tbatch_timespan = 1  # timespan / 500
        ...
        with trange(train_end_idx) as progress_bar2: 
            for j in progress_bar2:
                ...
                if timestamp - tbatch_start_time > tbatch_timespan:
                    ...
                    user_embeddings.cpu()
                    item_embeddings.cpu()
                    # user_embeddings_static.cpu()
                    # item_embeddings_static.cpu()
                    ...
                    with trange(len(lib.current_tbatches_user)) as progress_bar3:
                        for i in progress_bar3:
                            ...
                            item_embedding_output = model.forward(user_embedding_input,
                                                                  item_embedding_input,
                            ...
                            item_embeddings[tbatch_itemids, :] = item_embedding_output.cpu()
                            user_embeddings[tbatch_userids, :] = user_embedding_output.cpu()
