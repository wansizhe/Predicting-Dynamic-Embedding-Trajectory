...
class JODIE(nn.Module):
    def __init__(self, args, num_features, num_users, num_items):
        ...
        self.user_static_embedding_size = args.embedding_dim_static
        self.item_static_embedding_size = args.embedding_dim_static
        ...
        self.initial_user_embedding_static = nn.Parameter(torch.Tensor(args.embedding_dim_static))
        self.initial_item_embedding_static = nn.Parameter(torch.Tensor(args.embedding_dim_static))
        ...
        print(self.user_static_embedding_size + self.item_static_embedding_size + self.embedding_dim * 2)
        print(self.item_static_embedding_size + self.embedding_dim)
